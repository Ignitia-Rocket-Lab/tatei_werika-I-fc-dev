...
#define ERROR_WRITE_SUCCESS 0x01 // Everything worked as expected
 ...
 *
 * Note: 'x' in the Register Value column represents a placeholder for actual
 *bits. NA indicates that no register selection is needed for the unit.
 **/
